...
@WebServlet(name = "LoadAddProductController", urlPatterns = {"/LoadAddProductController"})
public class LoadAddProductController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            log("ERROR at LoadAddProductController: " + e.getMessage());
        } finally {
