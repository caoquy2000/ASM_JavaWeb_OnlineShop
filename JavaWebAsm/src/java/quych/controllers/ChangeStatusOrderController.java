 ...
 * @author caoho
 */
@WebServlet(name = "ChangeStatusOrderController", urlPatterns = {"/ChangeStatusOrderController"})
public class ChangeStatusOrderController extends HttpServlet {

    private static final String ERROR = "error.jsp";
    private static final String SUCCESS = "LoadOrderController";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            log("ERROR at ChangeStatusOrderController: " + e.getMessage());
        } finally {
