                ...
                <div class="table--history" style="display: flex; justify-content: center">
                    <c:if test="${requestScope.RESULT != null}">
                        <c:if test="${not empty requestScope.RESULT}" var="checkDTOs">
                            <table id="my-table" class="table" style="font-size: 1.4rem;">
                                <thead>
                                    <tr>
                                        <th scope="col">STT.</th>
                                    ...
                                    <c:forEach var="dto" items="${requestScope.RESULT}" varStatus="counter">
                                        <tr>
                                            ...
                                            <c:if test="${dto.getStatus() == 0}" >
                                                ...
                                                <td>
                                                    <c:url var="linkToDetailOrder" value="MainController">
                                                        <c:param name="action" value="ClientViewDetailOrder" />
                                                        <c:param name="id" value="${dto.getOrderID()}"/>
                                                    </c:url>
                                                    <a href="${linkToDetailOrder}">Xem</a>
                                                </td>
